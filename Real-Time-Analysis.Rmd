...
Get Texas 2019 tract data. Only grab total population, total housing units, and mobile home units. Then overlay and extract information about the Dayton, OH tornado.
```{r}
...
Nashville.sfdf <- st_transform(Nashville.sfdf, crs = st_crs(TN2018.sf))
Nashville.sfdf$ID <-  1:nrow(Nashville.sfdf)
TN2018.sf$ID2 <- 1:nrow(TN2018.sf)

out2018.sf <- aw_interpolate(Nashville.sfdf, 
               tid = "ID", 
               source = TN2018.sf, 
               sid = "ID2",
               extensive = c("B01001_001E", "B25024_001E", "B25024_010E"),
...
The Nashville, TN tornado impacted an estimated 97,227 people. It also impacted an estimate 43,678 housing units and 1275 mobile homes.
